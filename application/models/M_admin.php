...
//CONFIGURATION TABEL LIMIT GST
	public function insert_gst($data){
        $this->db->insert("limitstock",$data);
    }
    
    public function update_gst($where,$data){
        $this->db->update("gst_master",$data,$where);
    }

    public function delete_gst($where){
        $this->db->delete("limitgst_masterstock", $where);
    }

public function get_gst($select, $where){
        $data = "";
		$this->db->select($select);
...
//CONFIGURATION TABEL LIMIT STOCK
	...
	public function count_all_sales($where="", $like=""){
        $this->db->select("*");
        $this->db->from("sales");
		if ($like){
			foreach($like as $key => $value){ 
	...
	public function get_purchase_details($where="", $like=""){
        $this->db->select("*");
	...
	public function get_sales_details($where="", $like=""){
        $this->db->select("*");
