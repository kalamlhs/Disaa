...
<tbody>
	<?php $query=$this->db->query('SELECT * FROM purchase ORDER BY id DESC');
	      $result=$query->result();
		  $i=1;
		  foreach($result as $row){
			$supplierSql=$this->db->query('SELECT * FROM supplier WHERE id_supplier="'.$row->supplier_id.'"');
	      $supplier=$supplierSql->row();
		  ...
		  <tr>
           ...
           <td> <?php echo $supplier->nama_supplier;?></td>
			...
			<td style="width:18%;"> <a href="<?php echo base_url('website/purchase_details/'.$row->id);?>">
				<button class="btn btn-primary btn-sm"><i class="icon wb-eye "></i> Products</button></a>
<a href="<?php echo base_url('website/purchase_invoice/'.$row->id);?>" target="_blank">
		...
		<a href="<?php echo site_url();?>website/masuk/add">
        ...
        <div class="col-md-12">
            <div class="panel rounded-0">
                ...
                <div class="panel-body container-fluid">
                    <form action="<?php echo site_url();?>website/create_purchase" 
                          method="post" 
    ...
    <tr class="product-row">
        <td>
            <select name="product_id[]" class="form-control input-sm select2 product_id" style="width:100%;">
...
$(document).ready(function(){
    ...
    $('#id_supplier').change(function(){
        ...
        $.ajax({
            url : "<?php echo site_url('AjaxController/get_supplier_products');?>",
            type : "POST",
