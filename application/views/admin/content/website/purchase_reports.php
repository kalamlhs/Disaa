            ...
            <div class="row" style="margin-left: 9px!important;">
                ...
                <div class="col-md-3">
                    ...
                    <select name="supplier_id" class="form-control">
                        ...
                        <?php
                        $supplierList = $this->db->query("SELECT * FROM supplier ORDER BY nama_supplier ASC")->result();

                        foreach($supplierList as $sup){
                        ?>
                        <option value="<?php echo $sup->id_supplier; ?>"
                            <?php if($this->input->get('supplier_id') == $sup->id_supplier){ echo 'selected'; } ?>>
            ...
            Online
                ...
                <div class="col-md-3">
                    ...
                    <div>
						...
						<button type="button" onclick="exportTableToExcel('dataTable', 'Purchase_Report')" 
...
$netAmount=0;
        ...
        <tr>
            ...
            <td style="width:16%;">
                ...
                <a href="<?php echo base_url('website/purchase_details/'.$row->id); ?>">
