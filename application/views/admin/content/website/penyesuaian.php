						...
						<div class="panel-body container-fluid table-detail">
							<div class="table-full table-view">
								...
								<?php if($row->id_customer != 0) { ?>
									...
									<?php } ?>
									<?php } else {?>
										<small class="badge badge-success bg-success rounded-pill" style="text-decoration: none">SELF</small>
										<?php } ?>
												</td>
                                  ...
                                  <td>
												...
												<td>
													(<?php echo $row->gst;?>%) <?php echo $row->gst_amount;?>
												</td>
												<td>
								...
								<?php if($row->status_pergerakan == 1) { ?>
									<small class="badge badge-success bg-success rounded-pill" style="text-decoration: none">Purchase</small>
									<?php } else { ?>
										
									<small class="badge badge-danger bg-danger rounded-pill" style="text-decoration: none">Sale</small>
									<?php } ?>
								</td>
												<td>
													<?php echo dateIndo($row->tanggal_transaksi);?>
