...
.dataTables_info {
    ...
    padding: 2px 30px 12px !important;
...
.table-responsive1{
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>templates/backend/assets/css/select2.min.css">
	<script src="<?php echo base_url();?>templates/backend/assets/libs/jquery/jquery.js"></script>

	<script src="<?php echo base_url();?>templates/backend/assets/js/select2.min.js"></script>
	...
	<script src="<?php echo base_url();?>templates/backend/assets/js/jquery.dataTables.min.js"></script>
			...
			<div>
				<div>
					<ul class="site-menu">
						...
						<li class='site-menu-item <?php if( $method=="index") {?> active <?php }?>'>
...
<li class='site-menu-item <?php if( $method=="gst") {?> active <?php }?>'>
							<a href='<?php echo base_url();?>website/gst/edit/1' class='animsition-link'>
				...
				<li class='site-menu-item has-sub <?php if( $method=="supplier" || $method=="customer" || $method=="pengguna") {?> open <?php }?>'>
							...
							<ul class='site-menu-sub'>
								...
								<li class='site-menu-item <?php if( $method=="supplier") {?> active <?php }?>'>
								...
								<li class='site-menu-item <?php if( $method=="customer") {?> active <?php }?>'>
								...
								<?php } ?>
								<li class='site-menu-item <?php if( $method=="pengguna") {?> active <?php }?>'>
						...
						<li class='site-menu-item <?php if( $method=="products") {?> active <?php }?>'>
						...
						<!--<li class='site-menu-item <?php if( $method=="stock") {?> active <?php }?>'>
						...
						<?php endif; ?>
						<li class='site-menu-item has-sub <?php if( $method=="masuk" || $method=="keluar" || $method=="penyesuaian" ) {?> open <?php }?>'>
							<a href='javascript:void(0)' class='animsition-link'>
								<span class='site-menu-arrow'></span>
							...
							<ul class='site-menu-sub'>
								<?php if($admin->admin_level_kode === '1' || $admin->admin_level_kode === '2') {?>
								<li class='site-menu-item <?php if( $method=="masuk") {?> active <?php }?>'>
								...
								<?php } ?>
								<?php if($admin->admin_level_kode === '1' || $admin->admin_level_kode === '3') {?>
								<li class='site-menu-item <?php if( $method=="keluar") {?> active <?php }?>'>
						...
						<?php if($admin->admin_level_kode === '1') {?>
						<li class='site-menu-item has-sub <?php if( $method=="purchase_reports" || $method=="sales_reports" ) {?> open <?php }?>'>
							<a href='javascript:void(0)' class='animsition-link'>
								<span class='site-menu-arrow'></span>
							...
							<ul class='site-menu-sub'>
								<li class='site-menu-item <?php if( $method=="purchase_reports") {?> active <?php }?>'>
									<a href='<?php echo base_url();?>website/purchase_reports' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
										Purchase Products
										</span>
								...
								<li class='site-menu-item <?php if( $method=="sales_reports") {?> active <?php }?>'>
									<a href='<?php echo base_url();?>website/sales_reports' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
										Sale Products
										</span>
	...
	<script>
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#hapus-barang').attr("href", "<?php echo site_url();?>website/products/hapus/" + id);
