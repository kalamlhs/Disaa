        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="list-group rounded-0" id="notif-list">
                    ...
                    ?>
                        <div class="list-group-item list-group-item-action bg-danger rounded-0 border border-light"><?= $row['nama_barang'] ?> has only <b><?= $row['stock'] ?></b> Stock Left.</div>
                    <?php  endforeach; 
                    }else{?>
                    <div class="list-group-item list-group-item-action bg-success rounded-0 border border-light">No data found.</div>
                    <?php } ?>
